...
public class EnlightenmentCenter {
    ...
    public static void run(RobotController rc) throws GameActionException {
        ...
        if (setGuard == true) {
            ...
            if (!openSpots.get(baseLoc.translate(3, 3))) {
                spots.put(baseLoc.translate(3, 3), Direction.NORTHEAST);
            }
            if (!openSpots.get(baseLoc.translate(3, -3))) {
                spots.put(baseLoc.translate(3, -3), Direction.SOUTHEAST);
            }
            if (!openSpots.get(baseLoc.translate(-3, -3))) {
                spots.put(baseLoc.translate(-3, -3), Direction.SOUTHWEST);
            }
            if (!openSpots.get(baseLoc.translate(-3, 3))) {
                spots.put(baseLoc.translate(-3, 3), Direction.NORTHWEST);
            }
